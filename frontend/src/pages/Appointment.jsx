...
const Appointment = () => {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    if (i === 0) {
      ...
      const additionalHour = currentMinutes >= 30 ? 1 : 0

      currentDate.setHours(now.getHours() + additionalHour)
      currentDate.setMinutes(roundedMinutes)
      currentDate.setSeconds(0)
      currentDate.setMilliseconds(0)

      // Ensure minimum start time is 10:00 AM
  ...
  return docInfo && (
    <div >
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button className='bg-primary text-white text0sm font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
      </div>
